...
selected_files = { 'storage_result_scenario_19.csv', ...
                   'storage_result_scenario_20.csv', ...
                   'storage_result_scenario_21.csv', ...
                   'storage_result_scenario_22.csv', ...
                   'storage_result_scenario_23.csv', ...
                   'storage_result_scenario_24.csv'};
...
% Création d'une figure pour le premier graphique uniquement
figure;
